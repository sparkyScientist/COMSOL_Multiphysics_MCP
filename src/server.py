...
from .tools.mesh_setup import register_mesh_setup_tools
from .tools.study import register_study_tools
from .tools.solver_setup import register_solver_setup_tools
...
def register_all_tools() -> None:
    ...
    register_mesh_setup_tools(mcp)
    register_study_tools(mcp)
    register_solver_setup_tools(mcp)
